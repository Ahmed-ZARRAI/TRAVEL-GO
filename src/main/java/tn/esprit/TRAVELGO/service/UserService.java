...
public class UserService implements IUserservice, UserDetailsService {
    ...
    public ResponseEntity<ResponseMessage> registerCompany(User user,String id) {
    ...
    @Override
    public ResponseEntity<ResponseMessage> saveUser(User user,String id) {
        User existingUser = ur.findByUsername(user.getUsername());
        User user1 = new User();
    ...
    @Override
    public List<User> findByUserCompany(Long  id) {
    ...
    public void demandToRestPassword(@PathVariable("name") String username){
        ...
        if(user !=null){
            ...
            mailMessage.setFrom("ahmed.zarrai@esprit.tn");
            mailMessage.setText("To rest your password take code : "
                    +"code=          ?token="+ restPwdToken.getConfirmationToken());
            emailService.sendEmail(mailMessage);
