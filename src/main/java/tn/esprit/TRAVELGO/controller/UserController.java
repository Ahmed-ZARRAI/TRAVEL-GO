...
public class UserController {
    ...
    public ResponseEntity<List<User>>getUsers(){
        ...
        @PostMapping("/company/save/{file_id}")
        @PreAuthorize("hasRole('ROLE_COMPANY')")
        public void SaveUser(@RequestBody User user, @PathVariable(value = "file_id") String id) {
            us.saveUser(user,id);
        }
...
/********************************----register as company-----*********************/
    @PostMapping("/register/{file_id}")
    public void registerCompany(@RequestBody User user, @PathVariable(value = "file_id") String id) {
        us.registerCompany(user,id);
    }
 ...
 @DeleteMapping("/delete/{tokenid}/{id}")
    public ResponseEntity<?> deleteEmployee(@PathVariable("tokenid") Long tokenid,@PathVariable("id") Long id) {
        confirmationTokenRepository.deleteByTokenid(tokenid);
        userRepository.deleteById (id);
        return new ResponseEntity<>(HttpStatus.OK);
    }

    @DeleteMapping("/delete/{tokenid}")
    public ResponseEntity<?> deletetokenidxx(@PathVariable("tokenid") Long tokenid) {
        confirmationTokenRepository.deleteByTokenid(tokenid);
        return new ResponseEntity<>(HttpStatus.OK);
    }
    ...
    @DeleteMapping("/delete/{tokenid}")
    public ResponseEntity<?> deletetokenid(@PathVariable(value = "tokenid") Long tokenid) {
...
/********************************************************************************************/
    ...
    @ResponseBody
    public Optional<User> retrieveUserById(@PathVariable("user-id") Long id) {
   ...
   @GetMapping("/retrieve-user-by-company/{company-name}")
    @ResponseBody
    public List<User> findByUserCompany(@PathVariable("company-name") Long id ) {return us.findByUserCompany(id);
    }


    /**********************************************************************************/
   /* @PutMapping("/company/update/user/{id}/{file_id}")
    public User updateUser(@PathVariable(value = "id") Long id, @RequestBody User userRequest, @PathVariable(value = "file_id") String idf) {
        return userRepository.findById(id).map(user -> {
            ...
            user.setLocalisationCompany(userRequest.getLocalisationCompany());


            FileDB file = fileDBRepository.findById(idf).orElse(null);
            user.setFile(file);
